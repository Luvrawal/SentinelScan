...
export default function Home() {
  ...
  return <main className="shell">
    ...
    {report && <section className="report-shell">
      <div className="report-heading"><div><p className="eyebrow">SCAN REPORT</p><h2>Security findings for {report.target_url}</h2></div><div className="report-actions"><a className="download" href={`${API_URL}${report.pdf_url}`} download>Download PDF</a><a className="download secondary" href={`${API_URL}/api/scan/${report.scan_id}/sbom`} download>Export SBOM</a></div></div>
