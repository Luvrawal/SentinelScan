...
def report_html(scan) -> str:
    return REPORT_TEMPLATE.render(target=scan.target_url, summary="Review the prioritized findings and apply the remediation guidance.", technologies=scan.technologies, findings=scan.findings)
